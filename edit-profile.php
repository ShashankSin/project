...
<!-- Headerlinks end -->
    ...
    <div class="main-content">
        ...
        <div class="leftcol">
          ...
          <h1><u>Edit profile</U><span>Edit your personal details and login infos.</span></h1>
            ...
            <form method="post" action="member-dashboard.php" class="membership-signup">
              ...
              <tr>
                <th><span class="input-required">*</span>Your current password<span class="input-info">If you are changing password, please                enter your current password for validation</span></th>
                <th align="left"><input type="text" name="textfield5" id="textfield5"></th>
              </tr>
              <tr>
                <td><span class="input-required">*</span>New  password<span class="input-info">You can choose new password here or keep it unchanged                must be 6 or more characters</span></td>
                <td align="left"><input type="text" name="textfield6" id="textfield6"><div class="error-msg"><span>This&nbsp;field&nbsp;is&nbsp;required.</span></div></td>
              </tr>
              <tr>
                <th><span class="input-required">*</span>Confirm new password</th>
                <th align="left"><input type="text" name="textfield7" id="textfield7"></th>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td align="left"><input type="submit" name="button2" id="button2" value="Save profile" class="btn"></td>
              </tr>
              <tfoot>
              </tfoot>
            </table>
